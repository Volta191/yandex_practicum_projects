...
- **Other:** Unit economics metrics, cohort analysis, A/B testing, statistical hypothesis testing, machine learning (Scikit-learn)
...
| 04  | [Cumulative Project 1](./04_Cummulitive_Project_1)                | In this project, it is necessary to analyze the film distribution market and identify current trends.                                                                                                                               | `Python`, `Pandas`, `Matplotlib`, `Seaborn`                                                   |     |
| 05  | [Food Service Market Research](./05_Food_Service_Market_Research) | Market research of the food service industry to help investors choose a location for opening a food establishment.                                                                                                                  | `Python`, `Pandas`, `NumPy`, `Matplotlib`, `Seaborn`                                             |     |
...
| 11  | [SQL Final Project](./11_sql_final_project)                       | You have received a database from one of the competing services. It contains information about books, publishers, authors, as well as user reviews of books. This data will help formulate a value proposition for the new product. | `Python`, `SQL`, `sqlalchemy`                                                                    |     |
| 12  | [Final Project](./12_Mobile_App_Users_Behaviour(Final_Project))   | The goal of the analysis is to identify user behavior patterns and determine which user groups are more likely to return to the app and perform the target action — viewing contacts.                                               | `Python`, `Pandas`, `Matplotlib`, `SciPy` , `Seaborn`, `Numpy`                                   |     |
